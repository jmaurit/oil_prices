...
Unfortunately, In the formulation with a two-dimensional smoothed function, it is not possible to estimate a random effects component for computational reasons. 
